...
function Administrador() {
  ...
  // Obtener usuarios y sus imágenes
  useEffect(() => {
  ...
  if (loading) return <div>Cargando información del sistema óptico...</div>;

  return (
    <div className="admin-container">
      <h1>Panel de Administración - Gestión de Clientes y Archivos</h1>
      <table>
        <thead>
          <tr>
            <th>ID Cliente</th>
